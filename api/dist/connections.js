 ...
 */
router.post('/oauth/exchange', auth_1.authenticate, async (req, res) => {
    try {
 ...
 */
router.post('/oauth/refresh', auth_1.authenticate, async (req, res) => {
    try {
 ...
 */
router.post('/oauth/revoke', auth_1.authenticate, async (req, res) => {
    try {
 ...
 */
router.post('/oauth/validate', auth_1.authenticate, async (req, res) => {
    try {
        const { service, token } = req.body;
        if (!service || !token) {
 ...
 */
router.post('/sync/data', auth_1.authenticate, async (req, res) => {
    try {
...
// ==========================================
async function exchangeGoogleCode(code, service) {
...
// ==========================================
async function syncGmailData(connection) {
